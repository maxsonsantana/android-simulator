package maxson.com.br.maxbegin.ui.adapter;
...
import maxson.com.br.maxbegin.databinding.MatchItemBinding;
import maxson.com.br.maxbegin.domain.Match;
import maxson.com.br.maxbegin.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.tvAlwayTeamName.setText(match.getAwayTeam().getName());
